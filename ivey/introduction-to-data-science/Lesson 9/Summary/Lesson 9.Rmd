...
<center><img src="Figures/Figure9-1.png" alt="Figure 9.1"><br>
<div class="figCaption">__Figure 9.1__ -- *The hyperplane (line)* $1 + 2X_1 + 3X_2 = 0$ *is shown. The blue region is the set of points for which* $1 + 2X_1 + 3X_2 > 0$ *, and the purple region is the set of points for which* $1 + 2X_1 + 3X_2 < 0$.</div></center>
...
<center><img src="Figures/Figure9-2.png" alt="Figure 9.2"><br>
<div class="figCaption">__Figure 9.2__ -- Left: *There are two classes of observations, shown in blue and purple, each of which has measurements on two variables. Three separating hyperplanes, out of many possible, are shown in black.* Right: *A separating hyperplane is shown in black. The blue and purple grid indicates the decision rule made by a classifier based on this separating hyperplane.*</div></center>
...
<center><img src="Figures/Figure9-3.png" alt="Figure 9.3"><br>
<div class="figCaption">__Figure 9.3__ -- *The maximal margin hyperplane is shown as a solid line. The margin is the distance from the solid line to either of the dashed lines. The two blue points and the purple point that line on the dashed lines are the support vectors.*</div></center>
...
<center><img src="Figures/Figure9-4.png" alt="Figure 9.4"><br>
<div class="figCaption">__Figure 9.4__ -- *The two classes of observations are not separable by a hyperplane, and so the maximal margin classifier cannot be used.*</div></center>
...
<center><img src="Figures/Figure9-5.png" alt="Figure 9.5"><br>
<div class="figCaption">__Figure 9.5__ -- Left: *Two classes of observations are shown in blue and purple, along with the maximal margin hyperplane.* Right: *An additional blue observation has been added, leading to a dramatic shift in the maximal margin hyperplane.*</div><br></center>
...
<center><img src="Figures/Figure9-6.png" alt="Figure 9.6"><br>
<div class="figCaption">__Figure 9.6__ -- Left: *A support vector classifier fit to a small data set. The hyperplane is shown as a solid line and the margins are shown as dashed lines.* Right: *Same as left panel with two additional points on the wrong side of the hyperplane and the wrong side of the margin.*</div></center>
...
<center><img src="Figures/Figure9-7.png" alt="Figure 9.7"><br>
<div class="figCaption">__Figure 9.7__ -- *A support vector classifier was fit using four different values for the tuning parameter $C$. The largest value used is in the top left panel and smaller values were used in the top right, bottom left and bottom right panels.*</div><br></center>
...
<center><img src="Figures/Figure9-8.png" alt="Figure 9.8"><br>
<div class="figCaption">__Figure 9.8__ -- Left: *The observations fall into two classes, with a non-linear boundary between them.* Right: *The support vector classifier seeks a linear boundary, and consequently performs very poorly.*</div><br></center>
...
<center><img src="Figures/Figure9-9.png" alt="Figure 9.9"><br>
<div class="figCaption">__Figure 9.9__ -- Left: *A SVM with a polynomial kernel of degree 3 is applied to the non-linear data from Figure 9.8, resulting in a far more appropriate decision rule.* Right: *A SVM with a radial kernel is applied. In this example, either kernel is capable of capturing the decision boundary.*</div><br></center>
...
<center><img src="Figures/Figure9-12.png" alt="Figure 9.12"><br>
<div class="figCaption">__Figure 9.12__ -- *The SVM and logistic regression loss function are compared as a function of* $y_i(\beta_0 + \beta_1 x_{i1} + \cdots + \beta_p x_{ip})$*.*</div><br></center>
