...
<center><img src="Figures/Figure2-1.png" alt="Figure 2.1"><br>
<div class="figCaption">__Figure 2.1__ -- *Linear fit to* `sales` *based on 200 different markets for* `TV`*,* `radio` *and* `newspaper`*.*</div>
</center>
...
<center><img src="Figures/Figure2-2.png" alt="Figure 2.2"><br>
<div class="figCaption">__Figure 2.2__ -- *Non-linear fit for* `Income` *as a function of* `Years of Education`*.*</div>
</center>
...
<center><img src="Figures/Figure2-3.png" alt="Figure 2.3"><br>
<div class="figCaption">__Figure 2.3__ -- *Non-linear fit for* `Income` *as a function of* `Years of Education` *and* `Seniority`*.*</div>
</center>
...
<center><img src="Figures/Figure2-4.png" alt="Figure 2.4"><br>
<div class="figCaption">__Figure 2.4__ -- *Linear Model fit for* `Income` *as a function of* `Years of Education` *and* `Seniority`*.*</div>
</center>
...
<center><img src="Figures/Figure2-5.png" alt="Figure 2.5"><br>
<div class="figCaption">__Figure 2.5__ -- *Non-parametric Linear smooth thin-plate spline fit for* `Income` as a function of `Years of Education` *and* `seniority`*.*</div>
</center>
...
<center><img src="Figures/Figure2-7.png" alt="Figure 2.7"><br>
<div class="figCaption">__Figure 2.7__ -- *Illustration of tradeoff between flexibility and interpretability for various statistical learning methods.*</div>
</center> 
...
##### Example {-}
Figure 3.8 shows two unsupervised three-group clustering data sets. The situation on the right is more difficult because of overlapping observations.

<center><img src="Figures/Figure2-8.png" alt="Figure 2.8"><br>
<div class="figCaption">__Figure 2.8__ -- *Two examples using cluster analysis.* Left: *The data is clearly separated into three distinct groups.* Right: *The groupings are more difficult to identify.*</div>
</center>
...
<center><img src="Figures/Figure2-9.png" alt="Figure 2.9"><br>
<div class="figCaption">__Figure 2.9__ -- *Various estimates of simulated data and their mean squared errors.*</div><br></center>
...
<center><img src="Figures/Figure2-10.png" alt="Figure 2.10">
<div class="figCaption">__Figure 2.10__ -- *Various estimates of simulated data and their mean squared errors for approximately linear data.*</div></center>
...
<center><img src="Figures/Figure2-12.png" alt="Figure 2.12"><br>
<div class="figCaption">__Figure 2.12__ -- *Squared bias (blue), variance (orange), $\Var(\epsilon)$ (dashed line) and test MSE (red) for three data sets. The vertical dashed line indicates the flexibility level corresponding to the smallest test MSE.*</div></center>
...
<center><img src="Figures/Figure2-13.png" alt="Figure 2.13"><br>
<div class="figCaption">__Figure 2.13__ -- *Simulated data set of 100 observations in each of two groups indicated by blue and orange. The purple dashed line is the Bayes decision boundary.*</div><br></center>
...
<center><img src="Figures/Figure2-14.png" alt="Figure 2.14"><br>
<div class="figCaption">__Figure 2.14__ -- *Example of KNN with $K = 3$. The KNN decision boundary is illustrated in the right panel by the black curve.*</div><br></center>
...
<center><img src="Figures/Figure2-16.png" alt="Figure 2.16"><br>
<div class="figCaption">__Figure 2.16__ -- *Example of KNN for $K = 1$ and $K = 100$. The Bayes decision boundary is shown by the purple dashed line and the KNN decision boundary is the solid black curve.*</div><br></center>
...
<center><img src="Figures/Figure2-17.png" alt="Figure 2.17"><br>
<div class="figCaption">__Figure 2.17__ -- *The KNN training error rate (blue) and test error rate (orange) as the level of flexibility increases.*</div></center>